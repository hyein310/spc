...
# "회사 이름을 작명하고 싶어. 나의 회사는 게임을 만드는 회사야"
# "회사 이름을 작명하고 싶어. 나의 회사는 겨울 스포츠 물품을 만드는 회사야"

# template = "회사 이름을 작명하고 싶어. 나의 회사는 {product} 만드는 회사야."
# template = "회사 이름을 작명하고 싶어. 나의 회사는 {product} 만드는 회사야. 답변에 부가적인 설명은 하지마."
...
for product in test_products:
    ...
    resoponse = llm.invoke(prompt_result)
    print(f"{resoponse.strip()}\n")

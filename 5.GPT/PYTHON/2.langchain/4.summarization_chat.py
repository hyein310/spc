...
llm = ChatOpenAI(model="gpt-4o",temperature=0.4) # 요약이 목적이기 떄문에 창의성을 낮추기

chain = prompt | llm | RunnableLambda(lambda x: {"summary": x.content.strip()}) # 주의 (기존 x에서 chat모드에서는 content에 담겨 옴)
